...
namespace MyHealth.Controllers
{
    public class DoctorTimeSlotTablesController : Controller
    {
        ...
        public ActionResult Create(DoctorTimeSlotTable doctorTimeSlotTable)
        {
            ...
            {
                var find = db.DoctorTimeSlotTables.Where(d => d.DoctorID == doc.DoctorID && d.FromTime == doctorTimeSlotTable.FromTime && d.ToTime == doctorTimeSlotTable.ToTime).FirstOrDefault();
                if (find == null)
                {
